...
namespace ShadersTutorialXNA
{
    public class Game2 : Microsoft.Xna.Framework.Game
    {
        ...
        EffectParameter totalTimeParameter;

        Matrix rotateZombieMatrix;
        ...
        public void SetupShaderParameters()
        {
            ...
            totalTimeParameter = effect.Parameters["TotalTime"];
        }
        ...
        protected override void LoadContent()
        {
            ...
            theMesh = Content.Load<Model>("Models/sphere");
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            eyePos = new Vector3(100.0f, 2.0f, 100.0f);
            view = Matrix.CreateLookAt(eyePos, new Vector3(0, 2, 0), Vector3.Up);

            rotateZombieMatrix = Matrix.CreateRotationY((float)rotateCamera);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            worldParameter.SetValue(world * rotateZombieMatrix);
            ...
            totalTimeParameter.SetValue((float)rotateCamera);
